...
def attack(char_name: str, char_class: str) -> str:
    """Return "attack" value for selected character."""
...
def defence(char_name: str, char_class: str) -> str:
    """Return "defence" value for selected character."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Return "special" value for selected character."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Ask the user to enter a command or a pass.
    Call a function depending on the answer
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    """Ask the user to enter the name of the character,
    assign the value to the char_class variable.
    Return character description and char_class.
    """
